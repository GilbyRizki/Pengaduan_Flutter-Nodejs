...
import 'package:pengaduan_flutter/models/PengaduanModel.dart';
...
class PengaduanController extends GetxController{
  ...
  getData () async {
    try{
      data.value = [];
      loading.value = true;
      var response = await axios.get(Uri.parse("http://192.168.116.118:5000/pengaduan"));
      loading.value = false;
  ...
  createData (Map data) async {
    ...
    final url = Uri.parse('http://192.168.116.118:5000/pengaduan');
  ...
  updateData (Map data,id) async {
    ...
    final url = Uri.parse('http://192.168.116.118:5000/pengaduan/${id}');
  ...
  destroyData (id) async {
    try{
      ...
      var response = await axios.delete(
        Uri.parse("http://192.168.116.118:5000/pengaduan/${id}"),
      );
      loading.value = false;
